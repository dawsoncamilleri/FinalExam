...
function convTemp()
{
    ...
    {
        alert("You need to enter a value for either Degrees Celcius or Fahrenheit.");
    ...
    else if(isNaN(degrees) || isNaN(fahrenheit))
    {
        alert("Only numbers are accepted for this calculation!");
        document.getElementById("degrees").value = null;
        document.getElementById("fahrenheit").value = null;
    }
    else if(degrees != "")
